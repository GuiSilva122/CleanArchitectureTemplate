using CardType = CleanArchitectureTemplate.Services.Ordering.API.Application.Queries.CardType;
using Order = CleanArchitectureTemplate.Services.Ordering.API.Application.Queries.Order;

namespace CleanArchitectureTemplate.Services.Ordering.API.Controllers;
