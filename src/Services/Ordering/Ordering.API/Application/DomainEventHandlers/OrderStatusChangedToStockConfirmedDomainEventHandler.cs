using CleanArchitectureTemplate.Services.Ordering.Domain.AggregatesModel.BuyerAggregate;
using CleanArchitectureTemplate.Services.Ordering.Domain.AggregatesModel.OrderAggregate;
using CleanArchitectureTemplate.Services.Ordering.Domain.Events;

namespace CleanArchitectureTemplate.Services.Ordering.API.Application.DomainEventHandlers;
